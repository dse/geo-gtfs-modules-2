create table if not exists geo_gtfs (		name				varchar(32)	not null	primary key,
						value				text		null
);
delete from geo_gtfs where name = 'geo_gtfs.db.version';
insert into geo_gtfs (name, value) values('geo_gtfs.db.version', '0.1');

create table if not exists geo_gtfs_agency (	id				integer				primary key autoincrement,
...
create table if not exists geo_gtfs_feed (	id				integer				primary key autoincrement,
...
create table if not exists geo_gtfs_feed_instance (		id				integer				primary key autoincrement,
...
create table if not exists geo_gtfs_realtime_feed (		id				integer				primary key autoincrement,
						geo_gtfs_agency_id		integer		not null	references geo_gtfs_agency(id),
						url				text		not null,
...
create table if not exists geo_gtfs_realtime_feed_instance (	id				integer				primary key autoincrement,
...
-------------------------------------------------------------------------------
create table if not exists gtfs_agency (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_stops (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_routes (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_trips (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_stop_times (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_calendar (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
						service_id			text		not null,	-- indexed --
...
create table if not exists gtfs_calendar_dates (		geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
						service_id			text		not null,	-- indexed --
...
create table if not exists gtfs_fare_attributes (		geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_fare_rules (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_shapes (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_frequencies (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_transfers (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
...
create table if not exists gtfs_feed_info (			geo_gtfs_feed_instance_id	integer		not null	references geo_gtfs_feed(id),
